...
export const AI_CHECKLIST_STORAGE_KEY = 'ai-checklist';
export const AI_AGENT_CHECKLIST_STORAGE_KEY = 'ai-agent-checklist';

export const QUIZ_STORAGE_KEYS = TOPIC_ORDER.map((topicId) => `quiz-${topicId}`);
export const CHECKLIST_STORAGE_KEYS = [
    DEVICES_CHECKLIST_STORAGE_KEY,
    AI_CHECKLIST_STORAGE_KEY,
    AI_AGENT_CHECKLIST_STORAGE_KEY,
];
