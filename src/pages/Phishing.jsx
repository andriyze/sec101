        ...
        <div className="animate-fade-in">
            ...
            <section className="section">
                ...
                <div className="grid grid-cols-2 gap-6">
                    {[
                        t('phishing.red_flags.urgency', { returnObjects: true }),
                        t('phishing.red_flags.url', { returnObjects: true }),
                        t('phishing.red_flags.greeting', { returnObjects: true }),
                        t('phishing.red_flags.attachment', { returnObjects: true })
                    ].map((item, i) => (
            ...
            <section className="section">
                ...
                <div className="card panel-solid" style={{ marginBottom: '1.5rem' }}>
                    <ul className="list-clean">
                        {t('phishing.checklist.items', { returnObjects: true }).map((item, i) => (
                ...
                <div className="card">
                    ...
                    <ol style={{ paddingLeft: '1.2rem' }}>
                        {t('phishing.after_click.steps', { returnObjects: true }).map((item, i) => (
                ...
                <div className="card panel-solid">
                    ...
                    <div className="card" style={{ background: 'rgba(255,255,255,0.03)', borderColor: 'rgba(255,255,255,0.08)' }}>
                        ...
                        <ul style={{ paddingLeft: '1.2rem', color: 'var(--text-muted)' }}>
                            {t('phishing.annotated.callouts', { returnObjects: true }).map((item, i) => (
                                <li key={i} style={{ marginBottom: '0.35rem' }}>{item}</li>
                            ))}
                        </ul>
                    </div>
