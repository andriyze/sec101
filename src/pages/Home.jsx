  ...
  const topics = [
    {
      path: '/phishing',
      icon: '✉️',
      label: t('nav.phishing'),
      desc: t('home.cards.phishing.desc'),
      time: t('home.cards.phishing.time'),
    },
    {
      path: '/passwords',
      icon: '🔑',
      label: t('nav.passwords'),
      desc: t('home.cards.passwords.desc'),
    ...
    },
    {
      ...
      desc: t('home.cards.browsing.desc'),
      time: t('home.cards.browsing.time'),
    },
    {
      path: '/social',
      icon: '💬',
    ...
    },
    {
      ...
      desc: t('home.cards.advanced.desc'),
      time: t('home.cards.advanced.time'),
    },
  ]
    ...
    <div className="animate-fade-in">
      <div className="section" style={{ textAlign: 'center', padding: '3rem 0 2rem' }}>
        ...
        <p
          ...
          style={{ margin: '1rem auto 2rem', maxWidth: '720px', fontSize: '1.2rem' }}
        >
          {t('app.subtitle')}
        </p>
      ...
      <div className="section">
        <div className="section-header" style={{ alignItems: 'center' }}>
          <div className="section-title">
            ...
            <h2 style={{ margin: 0 }}>{t('home.start_here.title')}</h2>
          </div>
          <p className="section-subtitle" style={{ margin: 0 }}>
            {t('home.start_here.subtitle')}
          </p>
        </div>
        <div className="grid grid-cols-3 gap-6">
          {tArray(t, 'home.start_here.items').map((item, i) => (
            <div
              key={i}
          ...
          <div className="card panel-solid" style={{ borderLeft: '4px solid #00ff9d' }}>
            ...
            >
              ...
              <h3 style={{ margin: 0, color: '#00ff9d' }}>
                {t('home.security_vs_privacy.privacy.title')}
              </h3>
            </div>
      ...
      <div className="section">
        <div className="section-header" style={{ alignItems: 'center' }}>
          ...
          <span className="pill" style={{ marginTop: '0.25rem' }}>
            {t('home.stack.reviewed')}
          </span>
        </div>
        <div className="grid grid-cols-4 gap-6">
          <a
            ...
            className="card panel-solid stack-card"
        ...
        <div className="alert alert-info" style={{ marginTop: '1.5rem' }}>
          ...
          <p style={{ margin: 0 }}>
            <strong>{t('home.stack.mfa_reminder.title')}</strong>{' '}
            {t('home.stack.mfa_reminder.desc')}
          </p>
        </div>
        <p style={{ margin: '0.75rem 0 0', color: 'var(--text-muted)', fontSize: '0.9rem' }}>
          {t('home.stack.disclosure')}
        </p>
      </div>
          ...
          {topics.map(topic => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="icon-box" style={{ marginBottom: 0 }} aria-hidden="true">
                    {topic.icon}
                  </div>
                  <div>
                    <h3 style={{ margin: 0 }}>{topic.label}</h3>
                    <div className="pill" style={{ marginTop: '0.3rem', fontSize: '0.85rem' }}>
                      {topic.time}
                    </div>
                  </div>
                </div>
