    ...
    <div className="animate-fade-in">
      ...
      <section className="section">
        <div className="section-title" style={{ marginBottom: '1rem' }}>
          <Lock size={24} color="#00ff9d" />{' '}
          <h3 style={{ margin: 0 }}>{t('social.messaging.title')}</h3>
        </div>
        ...
        <div className="card panel-solid" style={{ marginTop: '1.5rem' }}>
          <h4 style={{ marginBottom: '0.5rem' }}>{t('social.telegram_viber.title')}</h4>
          <p style={{ color: 'var(--text-muted)', marginBottom: '1rem' }}>
            {t('social.telegram_viber.intro')}
          </p>
          <div className="grid grid-cols-2 gap-6">
            {tArray(t, 'social.telegram_viber.items').map(item => (
      ...
      <section className="section">
        <div className="section-title" style={{ marginBottom: '1rem' }}>
          ...
          <h3 style={{ margin: 0 }}>{t('social.vpn.title')}</h3>
        </div>
        ...
        <p style={{ marginBottom: '1.5rem' }}>{t('social.vpn.intro')}</p>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="card card-recommended">
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.75rem' }}>
              ...
              <h3 style={{ margin: '0 0 0 1rem' }}>ProtonVPN</h3>
            </div>
            <p>{t('social.vpn.proton')}</p>
            <a
            ...
            >
              {t('common.get')} ProtonVPN <span style={{ marginLeft: '5px' }}>→</span>
            </a>
          </div>
          <Card
            title="Mullvad"
            icon="🔐"
            description={t('social.vpn.mullvad')}
            link="https://mullvad.net"
            linkText={t('common.get') + ' Mullvad'}
          />
          <Card
            title="IVPN"
            icon="⚡"
      ...
      <section className="section">
        <div className="section-title" style={{ marginBottom: '1rem' }}>
          ...
          <h3 style={{ margin: 0 }}>{t('social.email.title')}</h3>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="card panel-solid">
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
              ...
              <h3 style={{ margin: '0 0 0 1rem' }}>Gmail</h3>
            </div>
            <p>{t('social.email.gmail.desc')}</p>
          </div>
        </div>
      </section>
      ...
      {/* Quiz */}
      <section className="section">
        <Quiz title={t('social.quiz.title')} questions={quizQuestions} storageKey="quiz-social" />
      </section>
